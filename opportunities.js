...
function renderCustomCalendarDays() {
    ...
    const todayStr = getTodayFormatted(); // استخراج تاريخ اليوم لمعالجته في التقويم
    ...
    for (let day = 1; day <= totalDays; day++) {
        ...
        // تمييز اليوم الحالي بدائرة فارغة
        if (dateStr === todayStr) {
            daySpan.classList.add('today-day');
        }

        // تمييز اليوم الذي تم تحديده باللون المناسب (دائرة ممتلئة)
