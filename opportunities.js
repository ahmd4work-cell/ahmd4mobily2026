...
function applySelectedDate(dateStr) {
    ...
    if (mainRow) {
        ...
        addToActivityLog('التاريخ المتوقع', formatDateToDisplay(oldVal), formatDateToDisplay(dateStr), companyName);
...
// تم إضافة الدوال الناقصة هنا لتصبح عامة (Global) ومقروءة بواسطة ملف HTML
