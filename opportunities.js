...
window.openNote = openNote; // Make it globally accessible
...
function setupCalendarEvents() {
    ...
    clearBtn?.addEventListener('click', () => {
        applySelectedDate(""); // تفريغ التاريخ وحفظه كفارغ
    });
...
window.openCustomDatePicker = function(event, el, rowId) {
    ...
    activeInputHiddenTarget = el.nextElementSibling; // الحقل المخفي الخاص بالفرص البيعية
