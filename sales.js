...
// تم التعديل لتوليد التاريخ دائماً بصيغة DD-MM-YYYY
...
function formatDateDisplay(dateString) {
    ...
    if (parts.length === 3) {
        if (parts[0].length === 4) { // إذا كانت السنة في البداية YYYY-MM-DD
...
function renderTableRow(obj) {
    ...
    // تم إضافة تنسيقات المحاذاة والاتجاه لحقول التواريخ
    row.innerHTML = `
