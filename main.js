// ==========================================
// main_5.js - لوحة القيادة العامة وتكامل السحابة والوضع الليلي (مع نظام البحث المخصص للرئيسية)
// ==========================================
import { db } from './firebase-config.js';
import { collection, onSnapshot, doc, setDoc } from "https://www.gstatic.com/firebasejs/10.12.5/firebase-firestore.js";

// تخزين البيانات للبحث الشامل
...
// ==========================================
// نظام البحث الشامل الدقيق المخصص للوحة القيادة
// ==========================================
function initGlobalSearch() {
    const searchInput = document.getElementById('globalSearchInput');
    const searchResults = document.getElementById('searchResults');
    
    // التوقف التلقائي في حال عدم وجود شريط البحث (مما يمنع الخطأ في باقي الصفحات)
    ...
    searchInput.addEventListener('input', (e) => {
        ...
        // معالجة البحث في الأعمدة المطلوبة مع مراعاة أي تغير محتمل في أسماء الحقول
        ...
        // البحث مقتصر على الصفحات الأربعة المحددة
