...
// دالة عرض السجلات بتنسيق HTML الجديد المدمج
...
// دالة متقدمة لتوليد النشاط وحفظه سحابياً ومحلياً
...
async function saveNewCustomer() {
    ...
    try {
        ...
        // إرسال النشاط عبر الدالة الجديدة
...
async function saveNote() {
    ...
    try {
        ...
        await addToActivityLog('إجراء', 'إضافة ملاحظة جديدة', '', customer.comp);
...
Object.assign(window, {
    ...
    handleBulkAction,
    toggleLogExpansion,
    addToActivityLog // متوفرة للوصول الشامل في حالة التحديث من مصادر أخرى
});
