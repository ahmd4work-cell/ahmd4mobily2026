// ==========================================
// customers.js - إدارة العملاء سحابياً
// ==========================================
...
// حفظ النسخة الاحتياطية محلياً لمنع ضياع البيانات عند الـ Refresh
...
// جلب البيانات من Firestore ثم المزامنة الاحتياطية
async function loadSavedData() {
    // 1. عرض البيانات المخزنة محلياً فوراً لضمان سرعة التحميل وعدم الاختفاء
    ...
    // 2. مزامنة وجلب أحدث البيانات المباشرة من Firestore
    try {
        ...
        // تحديث النسخة المحلية وعرض أحدث نسخة
        saveLocalBackup();
        updateStats(customersDataList);
        renderCustomers(customersDataList);
        renderLogs(logsDataList);
...
// تصدير الدوال للـ Global Window
