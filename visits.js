...
function renderCalendarDays(dateObj) {
    ...
    // مربعات فارغة للأيام قبل بداية الشهر
    ...
    for (let d = 1; d <= daysInMonth; d++) {
        ...
        if (currentIterDate.getDay() === 0 || currentIterDate.getDay() === 6) {
            dayDiv.classList.add('weekend-day'); // الأحد والسبت
        }
...
Object.assign(window, {
    ...
    openDatePicker, closeDatePicker, setTodayDate // تم إضافة دوال التقويم للنافذة
});
