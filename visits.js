    ...
    mainRow.innerHTML = `
        ...
        <td class="col-mobile" style="font-weight:700;">
            <div class="phone-cell-container">
                ...
                <a class="whatsapp-icon-btn" onclick="openWhatsApp(this)"><i class="fab fa-whatsapp"></i></a>
            </div>
        </td>
        ...
        <td class="col-date" onclick="openDatePicker('${rowId}', this)">
        ...
        <td class="col-service">
            ...
            <div class="custom-tooltip-container" data-tooltip="${escapeHTML(v.curServ || '')}">
                <div class="toggle-arrow" onclick="toggleSubTable('${rowId}')"><i class="fas fa-caret-left"></i></div>
            </div>
        </td>
        ...
        <td class="col-notes"><div class="notes-preview" data-full-notes='${notesJson.replace(/'/g, "&#39;")}' onclick="openNoteModal('${rowId}', this)">${escapeHTML(lastNoteText)}</div></td>
        <td class="col-status">
...
// تعريض بعض الدوال الرئيسية لـ window إذا استُدعيت مباشرة من HTML
