...
function renderRow(v = {}) {
    ...
    mainRow.innerHTML = `
        ...
        <td><input type="text" dir="ltr" class="excel-input readonly-input" value="${visitDate}" style="color:var(--text-muted); font-weight:700; unicode-bidi: isolate;" readonly><input type="hidden" class="visit-date-val opp-date-val" value="${visitDate}"></td>
        <td>
