...
function listenToVisits() {
    ...
    onSnapshot(visitsRef, (snapshot) => {
        ...
        // تحديث التخزين المحلي لدعم البحث الشامل عبر النظام
...
// ==========================================
// التهيئة عند تحميل الصفحة ونظام البحث الشامل
// ==========================================
...
window.migrateToOpportunities = migrateToOpportunities;
