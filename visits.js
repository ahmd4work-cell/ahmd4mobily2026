...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // البيانات المخزنة محلياً أو المستدعاة من النظام
    const getSystemData = () => {
        return {
    ...
    // أسماء الصفحات بالعربية والشارات المصاحبة
    const pageMeta = {
    ...
    // الاستماع لإدخال النص في خانة البحث
    if (searchInput) {
        searchInput.addEventListener('input', (e) => {
            ...
            // البحث في الصفحات الأربع والأعمدة المحددة
    ...
    // طباعة نتائج البحث داخل القائمة
